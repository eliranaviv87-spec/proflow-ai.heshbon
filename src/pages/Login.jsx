    ...
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 rounded-lg shadow-xl p-8 border border-slate-700">
          ...
          <button type="button" onClick={handleGoogleLogin} className="w-full bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 rounded-lg transition flex items-center justify-center gap-2">
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-slate-600"></div></div>
            <div className="relative flex justify-center text-sm"><span className="px-2 bg-slate-800 text-slate-400">אין לך חשבון?</span></div>
          </div>
        ...
        <p className="text-center text-slate-400 text-sm mt-6">בכניסה, אתה מסכים לתנאי השירות ומדיניות הפרטיות</p>
      </div>
    </div>
  );
}
